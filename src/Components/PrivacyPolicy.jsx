  ...
  return (
    <>
      <div className="container">
        <h1 className="text-center fw-bold pt-4 mt-3">Privacy Policy</h1>
        <div className="">
          <h3 className="pt-3 mt-4">General information</h3>
          <p className="pt-3 text-muted">
            ...
            make sharing with others quicker and easier.
          </p>

          <p className="text-muted">
            As you use our services, we want you to be clear how we’re using
            information and the ways in which you can protect your privacy. This
        ...
        <div className="">
          <h3 className="pt-5">Right to access, correct and delete data</h3>
          <p className="pt-3 text-muted">
          ...
          <p className="text-muted">
            However, the Company does not control each and every risk related to
            the use of the Internet, and therefore warns the Site users of the
            potential risks involved in the functioning and use of the Internet.
            The Site may include links to other web sites or other internet
            sources.
          </p>

          <p className="text-muted">
            As the Company cannot control these web sites and external sources,
            the Company cannot be held responsible for the provision or display
            of these web sites and external sources, and may not be held liable
            for the content, advertising, products, services or any other
            material available on or from these web sites or external sources.
          </p>
        </div>

        <div className="">
          <h3 className="pt-4 mt-3">Management of personal data</h3>
          <p className="pt-3 text-muted">
            ...
            following the directions in that message.
          </p>
        ...
        <div className="">
          <h3 className="pt-4 mt-3">Information we collect</h3>
          <p className="pt-3 text-muted">
          ...
          <p className="text-muted">
            ...
            address in order to customize certain services to your location. The
            data we collect depends on the services and features you use.
          </p>
        </div>

        <div className="">
          <h3 className="pt-4 mt-3">How we use your information</h3>
          <p className="pt-3 text-muted">
          ...
          <p className="text-muted">
            ...
            procedural safeguards designed to prevent certain data combinations.
            For example, we store data we collect from you when you are
          ...
          <p className="text-muted">We may also disclose personal data as part of a corporate transaction such as a merger or sale of assets.</p>
        </div>

        <div className="mb-5">
          <h3 className="pt-4 mt-3">Sharing your information</h3>
          <p className="pt-3 text-muted mb-5">
