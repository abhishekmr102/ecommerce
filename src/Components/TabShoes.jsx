  ...
  return (
    ...
    <Slider {...settings}>
      ...
      <div className="col-md-3">
        ...
        <div className="tabshoes_small_img ms-5"></div>
        <div className="tabshoes_small_img"></div>
        </div>
      ...
      <div className="col-md-3">
        ...
        <div className="tabshoes_small_img ms-3"></div>
        <div className="tabshoes_small_img"></div>
        <div className="tabshoes_small_img"></div>
        <div className="tabshoes_small_img"></div>
        </div>
